<script lang="ts">
    ...
    $: formattedDate =
        $currentLanguage === 'fr'
            ? new Date(data.cocktail.createdAt).toLocaleDateString('fr-FR', {
                  day: '2-digit',
                  month: '2-digit',
                  year: 'numeric'
              })
...
<div class="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white">
    <div class="container mx-auto px-4 py-16">
        <div class="max-w-2xl mx-auto bg-gray-800 rounded-lg shadow-lg p-8">
            <a href="/cocktails" class="text-blue-400 hover:text-blue-300 mb-6 inline-block">
            ...
            {#if data.cocktail.description}
                <p class="text-gray-300 text-lg mb-6 whitespace-pre-wrap">
                    ...
                    <ul class="divide-y divide-gray-700">
                        {#each data.cocktail.doses as dose}
                            <li class="py-2 flex items-center">
                                <span
                                    class="inline-flex items-center justify-center w-6 h-6 bg-blue-600 rounded-full mr-3 text-sm font-bold"
                                >
                                    {dose.number}
                                </span>
