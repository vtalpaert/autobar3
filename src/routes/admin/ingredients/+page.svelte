...
<div class="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
    ...
    >
      ...
      {/if}
      {#if debugInfo}
        <div class="mt-2 p-2 bg-gray-900 rounded text-xs text-gray-300 font-mono whitespace-pre-wrap">
          {debugInfo}
        </div>
      {/if}
    </form>
      ...
      <tbody>
        {#each data.ingredients as ingredient}
          <tr>
            ...
            <td class="px-4 py-2 border-b border-gray-600 text-white">{ingredient.alcoholPercentage}%</td>
            <td class="px-4 py-2 border-b border-gray-600 text-white">{ingredient.density}</td>
            <td class="px-4 py-2 border-b border-gray-600 text-white">{ingredient.addedSeparately ? 'Yes' : 'No'}</td>
