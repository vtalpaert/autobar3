        ...
        return new Promise((resolve, reject) => {
            ...
            img.onload = () => {
                ...
                ctx.drawImage(
                    ...
                    startY,
                    size,
                    size, // Source rectangle (square crop from center)
                    0,
                    0,
                    TARGET_SIZE,
...
<div class="mb-4">
    <label for="image-upload-input" class="block text-sm font-medium mb-2">
        ...
        {#if !disabled}
            <span class="text-sm text-gray-400 font-normal">
                {uploadHint === '(Click, drag & drop, or paste Ctrl+V)'
                    ? t.createCocktail.imageUploadHint
                    : uploadHint}
            </span>
        {/if}
    </label>
    ...
    {:else}
        ...
        >
            {#if processing}
                <div
                    class="animate-spin rounded-full h-12 w-12 border-b-2 border-gray-400 mx-auto mb-4"
                ></div>
            ...
            {:else}
                ...
                <p class="text-gray-300 mb-2">
                    ...
                    {:else}
                        {uploadText === 'Click to upload, drag & drop, or paste image'
                            ? t.createCocktail.imageUploadText
                            : uploadText}
                    {/if}
                </p>
