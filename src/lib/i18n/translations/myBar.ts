    ...
    en: {
        myBar: {
            ...
            orders: {
                ...
                orderCocktail: 'Order a Cocktail',
                status: {
                    title: 'Status',
                    pending: 'Pending',
                ...
                nowPouring: 'Now pouring:',
                stepOf: 'Step {current} of {total}',
                recipeTimeline: 'Recipe Timeline',
    ...
    fr: {
        myBar: {
            ...
            orders: {
                ...
                orderCocktail: 'Commander un Cocktail',
                status: {
                    title: 'Statut',
                    pending: 'En attente',
                ...
                nowPouring: 'Versement en cours:',
                stepOf: 'Étape {current} sur {total}',
                recipeTimeline: 'Chronologie de la Recette',
